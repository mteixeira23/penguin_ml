...
st.markdown('Use this Streamlit app to make your own sccaterplot about penguins!')
...
penguins_df = pd.read_csv('C:\\Users\\Acer\\Desktop\\palmer\\penguin.csv', sep=',', encoding='UTF-8', decimal=',')
